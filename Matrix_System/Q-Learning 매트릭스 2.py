...
path_1 ="C:/Users/leewa/Desktop/GM_Matrix_model_240723 - 복사본.spp"
...
q_table_data.to_excel("C:/Users/leewa/Desktop/Q-table/Episode_table_2.xlsx")
c_max_list = pd.DataFrame(c_max_list)
c_max_list.to_excel("C:/Users/leewa/Desktop/Q-table/c_max_list_2.xlsx")

with pd.ExcelWriter("C:/Users/leewa/Desktop/Q-table/State_table_2.xlsx") as writer:
    for idx, df in enumerate(all_state):
        sheet_name = f'Episode{idx + 1}'  # 각 시트의 이름을 'Sheet1', 'Sheet2', ...로 설정
        df.to_excel(writer, sheet_name=sheet_name, index=False)


spent_time : 16:41:027.89
min_makespan : 11:32:010.79
Best_Scenario : (0, 2, 1, 0, 2, 0, 2, 2, 0, 2)